...
class NowPlayingViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(NowPlayingViewController.didBecomeActiveNotificationReceived), name: NSNotification.Name(rawValue: "UIApplicationDidBecomeActiveNotification"), object: nil)
        
        // Notification for MediaPlayer metadata updated
        NotificationCenter.default.addObserver(self, selector: #selector(NowPlayingViewController.metadataUpdated(withNotification:)), name: .MPMoviePlayerTimedMetadataUpdated, object: nil)
    ...
    deinit {
        ...
        NotificationCenter.default.removeObserver(self, name: NSNotification.Name.MPMoviePlayerTimedMetadataUpdated, object: nil)
    }
    ...
    func stationDidChange() {
        radioPlayer.stop()
        radioPlayer.contentURL = URL.init(string: currentStation.stationStreamURL)
        radioPlayer.prepareToPlay()
        radioPlayer.play()
...
//            
//            if let url = URL.init(string: track.artworkURL) {
//                
...
//            
    ...
    func queryAlbumArt() {
        ...
        DataManager.getTrackDataWithSuccess(queryURL: escapedURL!, success: {
            (data) in
            if DEBUG_LOG {
    ...
    @objc func metadataUpdated(withNotification n: Notification)
    {
